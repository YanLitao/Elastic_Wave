...
%crack dimension 
a = 150;
crack_tip_left = src_nx - a; 
crack_tip_left_end = src_nx - 3;
crack_tip_right_start = src_nx + 3;
crack_tip_right = src_nx + a - 1;
...
for n=1:nt
    ...
    Txz(crack_tip_right_start: crack_tip_right, offset) = zeros(length(crack_right),1);
...
%                uz(i,j) = 0;
    ...
    if (mod(n,5)==0)
        ...
        plot(x2d(crack_tip_left:crack_tip_left_end,offset),z2d(crack_tip_left:crack_tip_left_end,offset),'w-','LineWidth',2);
        plot(x2d(crack_tip_right_start:crack_tip_right,offset),z2d(crack_tip_right_start:crack_tip_right,offset),'w-','LineWidth',2);
        %source position
